...
class hmnet(nn.Module):
    ...
    def forward(self, img, img_hf):    
        ...
        # shallow feature
        fea_shallow_x4 = self.heads[0](torch.cat([imgx4, imgx4_hf], dim=1))
        fea_shallow_x2 = self.heads[1](torch.cat([imgx2, imgx2_hf], dim=1))
        fea_shallow_x1 = self.heads[2](torch.cat([imgx1, imgx1_hf], dim=1))
