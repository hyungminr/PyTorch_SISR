...
class hmnet(nn.Module):
    ...
    def forward(self, img):    
        ...
        _fea_shallow_x2 = fea_shallow_x2
        _fea_shallow_x1 = fea_shallow_x1
        ...
        features = dict()
        features['mshf'] = dict()
        features['mshf']['x4'] = fea_mshf_x4
        features['mshf']['x2'] = fea_mshf_x2
        features['mshf']['x1'] = fea_mshf_x1
        
        features['shallow'] = dict()
        features['shallow']['x4'] = fea_shallow_x4
        features['shallow']['x2'] = fea_shallow_x2
        features['shallow']['x1'] = fea_shallow_x1
        
        features['shallow']['_x2'] = _fea_shallow_x2
        features['shallow']['_x1'] = _fea_shallow_x1
        
        features['deep'] = dict()
        features['deep']['x4'] = fea_deep_x4
        features['deep']['x2'] = fea_deep_x2
        features['deep']['x1'] = fea_deep_x1
        
        features['fea'] = dict()
        features['fea']['x4'] = fea_x4
        features['fea']['x2'] = fea_x2
        features['fea']['x1'] = fea_x1
        
        return img_x4, img_x2, img_x1, features
