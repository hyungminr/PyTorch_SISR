...
class hmnet(nn.Module):
    ...
    def __init__(self, args=None, num_RB=16, num_feats=64, scale=4, kernel=3, padding=1, bias=True):
        ...
        layers  = [nn.Conv2d(in_channels=num_feats, out_channels=num_feats*4, kernel_size=1, padding=0, bias=bias)]
        layers += [nn.Conv2d(in_channels=num_feats, out_channels=num_feats*4, kernel_size=1, padding=0, bias=bias)]
        ...
        self.feaAtt_x1 = FeatureAtt4()
        self.feaAtt_x2 = FeatureAtt5()
    ...
    def forward(self, img):    
        ...
        fea_shallow_x2_att = self.feaAtt_x2_down(fea_shallow_x2, self.downConv[0](fea_shallow_x4))
        fea_shallow_x1_att = self.feaAtt_x1_down(fea_shallow_x1, self.downConv[1](fea_shallow_x2))
        ...
        fea_x1 = self.feaAtt_x1(fea_shallow_x1, fea_shallow_x1_att, fea_deep_x1, fea_mshf_x1)
        fea_x1_to_x2 = self.pixelShuffle(self.upConv[0](fea_x1))
        
        fea_x2 = self.feaAtt_x2(fea_shallow_x2, fea_shallow_x2_att, fea_deep_x2, fea_x1_to_x2, fea_mshf_x2)
        ...
        img_x4 = self.add_mean(up_x4 + imgx4)
        img_x2 = self.add_mean(up_x2 + imgx2)
        img_x1 = self.add_mean(up_x1 + imgx1)
