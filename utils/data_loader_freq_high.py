...
class dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.height > 0 and self.width > 0:
            ...
            output_hf_tensor_cropped = self.crop_image(output_hf_tensor, crop, mode='hr')
            ...
            output_hf_tensor = output_hf_tensor_cropped
        ...
        if hflip:
            ...
            output_hf_tensor= torch.tensor(output_hf_tensor.numpy()[:,:,::-1].copy())
        ...
        return input_tensor, input_hf_tensor, output_tensor, output_hf_tensor, output_name
